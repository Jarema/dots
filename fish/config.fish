...
alias cat="bat"
alias ls="lsd"
alias cargo-clippy="cargo clippy --benches --tests --examples --all-features -- --deny clippy::all"
alias swift-fmt="swift-format format -i --configuration .swift-format -r Sources Tests"
alias swift-lint="swift-format lint --configuration .swift-format -r Sources Tests"
set -gx EDITOR nvim
set -gx GPG_TTY (tty)
